...
namespace RosUnity
{
    ...
    {
        public enum PoseMessageTypes { GeometryPoseStamped, NavigationOdometry, GeometryPose };
        ...
        private void SetType()
        {
            ...
            else if (PoseMessageType == PoseMessageTypes.GeometryPose)
            {
                type = typeof(GeometryPose);
                MessageReception += ReceiveGeometryPoseMessage;
            }
        ...
        private void ReceiveGeometryPoseMessage(object sender, MessageEventArgs e)
        {
            position = GetPosition((GeometryPose)e.Message).Ros2Unity();
            isMessageReceived = true;
        }
